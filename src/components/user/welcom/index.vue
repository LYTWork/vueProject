    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card shadow="hover" class="mgb20" style="height:252px;">
          <div class="user-info">
            <img src="@/assets/img/candy.jpg" class="user-avator" alt >
        ...
        <el-card shadow="hover" style="height:252px;">
          ...
          <el-progress :percentage="71.3" color="#42b983"/>JavaScript
          <el-progress :percentage="24.1" color="#f1e05a"/>CSS
          <el-progress :percentage="13.7"/>HTML
